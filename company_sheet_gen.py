...
#    with open(printer_name, "w") as printer:
    ...
    print(f"\nCAREER: ", f"{employee.role.capitalize()}:")
    print(f"\nHEALTH   STRESS   DRIVE")
    print(f"\n╓───╖   ╓───╖   ╓───╖")
    print(f"\n║  {employee.health} ║   ║   ║   ║   ║")
    print(f"\n╙───╜   ╙───╜   ╙───╜")
    print(f"AWARE: {display_pips(employee.aware)}")
    print("SKILLS")
    for stat, points in employee.points_dict.items():
        print(f"{stat}: " + display_pips(points))
    ...
    print(f"╠═══════════════════════╣")
    print(f"Team Stress: {employee.team_stress}")
    print(f"╠═══════════════════════╣")
    print("Loadout:", ", ".join(employee.loadout))
    print(f"╚═══════════════════════╝")
